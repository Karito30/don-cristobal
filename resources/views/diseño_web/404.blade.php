...
<head>
	...
	<link rel="stylesheet" href="{{ asset('css/diseño_web/404.css')}}">
...
<body>
	...
	<div class="notfound-copy">
		...
		<title id="svgtitle1">404 Pagina no encontrada</title>
		<g class="404-text">
	...
	<img  class="img" src="imagen/zyro-image.png" alt="">

	<button type="submit" class="btn">
		<span> <a href="pagina.html"></a>inicio</span>
	  </button>

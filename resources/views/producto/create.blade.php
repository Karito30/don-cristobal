            ...
            <div class="col-xl-12">
                <form action="{{route('producto.store')}}" method="POST">
                    ...
                    <div class="form-group my-1">
                        ...
                        <input type="text" class="form-control" name="NOM_PRODUCTO" required maxlength="50">
                    </div>
                    <div class="form-group my-1">
                        <label for="VALOR_PRODUCTO">VALOR DEL PRODUCTO</label>
                        <input type="number" class="form-control" name="VALOR_PRODUCTO" id="VALOR_PRODUCTO" required min="1">
                        <small class="text-danger" id="valorError"></small>
                    </div>
                    <div class="form-group my-1">
                        <label for="CATEGORIA_PRODUCTO">CATEGORIA DEL PRODUCTO</label>
                        <input type="text" class="form-control" name="CATEGORIA_PRODUCTO"  required maxlength="50" >
                    </div>
                    <div class="form-group my-1">
                        <label for="CANT_PRODUCTO">CANTIDAD DEL PRODUCTO</label>
                        <input type="number" class="form-control" name="CANT_PRODUCTO" id="CANT_PRODUCTO" required min="1">
                        <small class="text-danger" id="cantidadError"></small>
                    </div>
                    <div class="form-group my-1">
                        <label for="ID_PROVEEDOR_FK_PRODUCTO">ID PROVEEDOR</label>
                        <select class="form-control" name="ID_PROVEEDOR_FK_PRODUCTO" id="ID_PROVEEDOR_FK_PRODUCTO" required>

            ...
            <div class="xol-xl-12">
                <form action="{{route('empleado.store')}}" method="POST">
                    ...
                    <div class="form-group my-1">
                        ...
                        <input type="date" class="form-control" name="FECHA_NA_EMPLEADO" required  >
                    </div>
                    <div class="form-group my-1">
                        <label for="NOM_EMPLEADO">NOMBRE DEL EMPLEADO</label>
                        <input type="text" class="form-control" name="NOM_EMPLEADO" required maxlength="50" >
                    </div>
                    <div class="form-group my-1">
                        <label for="NOMBRE_CARGO">CARGO</label>
                        <input type="text" class="form-control" name="NOMBRE_CARGO" required maxlength="50" >
                    </div>
                    <div class="form-group my-1">
